.data
	...
	byeMsg: .asciiz "Cam on"
	errorMsg: .asciiz "Loi Input"
	startMsg: .asciiz "Nhap bieu thuc trung to voi cac ki hieu +-*/^()% va gia tri tu 0-99"
...
# Get infix expression
	...
	la $a1, infix
 	la $a2, 256
 	syscall
 	beq $a1,-2,end #neu chon cancel thi ket thuc
 	beq $a1,-3,start #neu chon ok nhung khong nhap gi het
# Print infix 
	li $v0, 4
	la $a0, prompt_infix
	syscall
